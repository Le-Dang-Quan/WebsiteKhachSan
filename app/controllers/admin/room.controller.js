...
class roomController {
  ...
  async add(req, res) {
    ...
    try {
      ...
      if (!name || !description || !price || !people || !categoryId || !slug || !address ) return res.render('admin/room/add', {category, error: "Vui lòng nhập đủ thông tin của phòng này!"});
  ...
  async update(req, res) {
    ...
    try {
      ...
      if (!name || !description || !price || !people || !slug || !status || !address ) return res.render('admin/room/update', {room, category, error: "Vui lòng nhập đủ thông tin của phòng này!"});
