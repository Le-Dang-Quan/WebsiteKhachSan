...
class orderController {
    ...
    async lockup(req, res) {
        ...
        try {
            ...
            return res.render('website/lockup/result',{title: "Hosteller - Kết quả tra cứu thông tin đặt phòng", qrCode, order, room, numberDay, End, Start})
        }catch(error){
            console.error(error);
